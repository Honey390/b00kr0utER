  ...
  return (
    <div className="text-orange-900">
      <div className="grid grid-cols-1 gap-4 md:grid-cols-3 lg:gap-8">
        <div className="flex flex-col overflow-hidden rounded-lg bg-gradient-to-r from-stone-300 to-orange-200 shadow-sm dark:bg-gray-800 dark:text-gray-100">
          ...
          <a
            ...
            className="block bg-gradient-to-r from-stone-300 to-orange-200 p-3 text-center text-sm font-medium text-blue-600 hover:bg-gray-100 hover:bg-opacity-75 hover:text-blue-700 active:bg-gray-50 dark:bg-gray-900/50 dark:text-blue-400 dark:hover:bg-gray-900/75 dark:hover:text-blue-300 dark:active:bg-gray-900/50"
          >
            View All Sales
          </a>
        </div>
      ...
      <div className="bg-gradient-to-r from-stone-300 to-orange-200 mt-5 dark:bg-gray-800 dark:text-gray-100">
        <div className="container mx-auto grid grid-cols-1 gap-12 px-4 py-16 lg:grid-cols-2 lg:px-8 lg:py-32 xl:max-w-7xl">
          <div className="flex items-center text-center lg:text-left">
            <div className="">
              <div>
                <div className="mb-1 text-sm font-bold uppercase tracking-wider text-orange-700 dark:text-blue-500">
                  Get Started
                </div>
                <h2 className="mb-4 text-4xl font-black  dark:text-white">
                  Grow your business
                  <span className="text-orange-600 dark:text-blue-500">
                    {" "}
                    now
                  </span>
                  !
                </h2>
                <h3 className="text-xl font-medium leading-relaxed  dark:text-gray-300">
              ...
              <div className="mt-3">
                <a
                  href="javascript:void(0)"
                  className="inline-flex items-center justify-center space-x-2 rounded-lg border border-orange-100 bg-gradient-to-r from-stone-300 to-orange-200 px-6 py-3 font-semibold leading-6 text-white hover:border-blue-600 hover:bg-blue-600 hover:text-white focus:ring focus:ring-blue-400 focus:ring-opacity-50 active:border-blue-700 active:bg-blue-700 dark:focus:ring-blue-400 dark:focus:ring-opacity-90"
                >
                  <svg
                    className="hi-mini hi-plus-circle text-orange-700 inline-block size-5 opacity-90"
                    xmlns="http://www.w3.org/2000/svg"
                    viewBox="0 0 20 20"
                    fill="currentColor"
                    aria-hidden="true"
                  ...
                  <span className="text-orange-700">Create your Account</span>
                </a>
              </div>
            </div>
          </div>
